...
interface SuperadminUser { id: number; name: string; email: string }
      ...
      <DialogContent className="bg-surface border-divider max-w-[calc(100vw-2rem)] sm:max-w-sm">
        <DialogHeader>
          <DialogTitle className="text-lg font-bold text-text-primary flex items-center gap-2">
            <Pencil className="w-5 h-5 text-primary" /> Editar administrador
          </DialogTitle>
          <DialogDescription className="text-sm text-text-secondary">
            Actualiza el nombre o el email del administrador.
          </DialogDescription>
        </DialogHeader>
        {globalError && (
