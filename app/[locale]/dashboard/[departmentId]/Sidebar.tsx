      ...
      <div className="px-5 py-6 flex flex-col gap-5 mt-auto">
        {isSuperAdmin && (
          <div className="flex flex-col gap-1 -mt-2">
            <p className="px-1 pb-2 text-[10px] font-bold tracking-widest text-text-hint uppercase opacity-50">{t('settingsGroup')}</p>
            {(() => {
        ...
        <div className="p-4 rounded-2xl bg-surface-variant/40 border border-divider/50 space-y-3">
          <div>
            <p className="text-[10px] font-bold tracking-[0.15em] text-text-hint uppercase mb-1 opacity-60">{tCommon('company')}</p>
            <p className="text-sm font-bold text-text-primary truncate">{companyName}</p>
          </div>
          <div className="h-px bg-divider/30" />
          <div>
            <p className="text-[10px] font-bold tracking-[0.15em] text-text-hint uppercase mb-1 opacity-60">{tCommon('department')}</p>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-divider/50">
                <span className="text-sm font-bold text-text-primary">{tCommon('menu')}</span>
                <button
                  onClick={onClose}
