    ...
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-primary/30">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link 
            href="/"
            className="w-full sm:w-auto min-w-[160px] h-12 px-8 rounded-xl bg-primary text-on-primary text-sm font-medium hover:bg-primary-dark transition-all flex items-center justify-center gap-2 hover:-translate-y-0.5"
          >
